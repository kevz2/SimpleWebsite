      ...
      <div>
        <nav>
          <ul>
            ...
            <li>
              <Link to="/build1"><Thumbnail build_name="build1" /></Link>
            </li>
            <li>
              <Link to="/build2">Users</Link>
            </li>
          </ul>
        </nav>
...
function Home() {
  return (
    <div className="home">
      ...
      <div className="thumbnnail_array">
        <Thumbnail build_name='build_name_1' />
        <Thumbnail build_name='build_name_2' />
      </div>
    </div>
  );
}
